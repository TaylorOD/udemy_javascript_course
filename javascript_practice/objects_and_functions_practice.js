...
// # 6. Make an object to store 3 different states and their captitals. Then print write a function to print the 2nd state and capital.
...
let stateCapital = function (state) {
  return state.
}
